...
var $author$project$Main$FactorPool = F3(
	function (firstElement, furtherElements, changes) {
		return {aB: changes, P: firstElement, Q: furtherElements};
	});
...
var $author$project$Main$randomFactor = function (factorPool) {
	return A2($elm$random$Random$uniform, factorPool.P, factorPool.Q);
};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				var challenge = msg.a;
				return ((model.z <= 1) ? $author$project$Main$update(
						...
						[
							...
							A2(
								...
								A2(
									...
									A2($elm$core$List$cons, config.P, config.Q))))
						])),
					A2(
					$elm$html$Html$div,
					_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$core$String$fromInt(model.d.O))
							]),
						_List_Nil),
						A2(
						$elm$html$Html$div,
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Main$HideConfig(model.d))
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onClick(
						$author$project$Main$ShowConfig(model.d))
					]),
				_List_fromArray(
					[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text(
											$author$project$Main$maybeIntToString(challenge.D) + (' x ' + ($author$project$Main$maybeIntToString(challenge.E) + ' = ')))
										]))
								])),
							A2(
							$elm$html$Html$input,
...
var $author$project$Main$showMaybeChallenge = function (model) {
	...
	if (_v0.$ === 1) {
		...
		var c = _v0.a;
		return A2($author$project$Main$showCurrentChallenge, c, model.z);
	}
};
...
var $author$project$Main$calcResult = function (challenge) {
	var _v0 = _Utils_Tuple2(challenge.D, challenge.E);
	if (_v0.a.$ === 1) {
		if (_v0.b.$ === 1) {
			var _v1 = _v0.a;
			var _v2 = _v0.b;
...
var $author$project$Main$challengeToString = function (challenge) {
	return $author$project$Main$maybeIntToString(challenge.D) + (' x ' + ($author$project$Main$maybeIntToString(challenge.E) + (' = ' + $author$project$Main$maybeIntToString(
